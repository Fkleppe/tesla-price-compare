        ...
        <article style={{
          ...
          <div style={{ fontSize: 15, color: '#374151', lineHeight: 1.8 }}>
            ...
            <p style={{ marginBottom: 16 }}>
              EVPriceHunt is a price comparison website for Tesla accessories. We aggregate product information from various retailers to help you find and compare products. We are not affiliated with Tesla, Inc.
            </p>
            ...
            <p style={{ marginBottom: 16 }}>
              By using EVPriceHunt, you agree to:
            </p>
            ...
            <p style={{ marginBottom: 16 }}>
              EVPriceHunt earns commissions from purchases made through our affiliate links. This does not affect the price you pay. We include discount codes when available to help you save money.
            </p>
            ...
            <p style={{ marginBottom: 16 }}>
              EVPriceHunt is not liable for any damages arising from your use of this website or purchases made through our links. Your use of this site is at your own risk.
            </p>
